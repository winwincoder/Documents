...
static ALWAYS_INLINE void x264_reference_check_reorder( x264_t *h )
{
    int i, list;
...
static void x264_weighted_pred_init( x264_t *h )
{
    ...
    int i_padv, denom, buffer_next, weightplane[2];
...
static ALWAYS_INLINE int x264_reference_distance( x264_t *h, x264_frame_t *frame )
{
...
static ALWAYS_INLINE void x264_reference_build_list( x264_t *h, int i_poc )
{
    int b_ok, i, list;
...
static ALWAYS_INLINE int x264_reference_update( x264_t *h )
{
    int i, j;
...
static ALWAYS_INLINE void x264_reference_reset( x264_t *h )
{
...
static ALWAYS_INLINE void x264_reference_hierarchy_reset( x264_t *h )
{
    int ref;
...
static ALWAYS_INLINE void x264_slice_init( x264_t *h, int i_nal_type, int i_global_qp )
{
    /* ------------------------ Create slice header  ----------------------- */
...
{
    char psz_message[80];
    int frame_size, i, j, i_list, filler;
    double dur;
