...
static void x264_predict_16x16_dc_128_c( pixel *src )
{
    ...
    int i;
    PREDICT_16x16_DC( PIXEL_SPLAT_X4( 1 << (BIT_DEPTH-1) ) , i);
}
...
{
    int i;
    PREDICT_8x8_DC( PIXEL_SPLAT_X4( 1 << (BIT_DEPTH-1) ), i );
}
...
void x264_predict_8x8_v_c( pixel *src, pixel edge[36] )
{
    int y;
    pixel4 top[2];
    top[0] = MPIXEL_X4( edge+16 );
    top[1] = MPIXEL_X4( edge+20 );
