...
#include <stdio.h>
//#include <sys/stat.h>  //by zhengxuefeng, 2015-12-5
#include <inttypes.h>
#include <stdarg.h>
...
//modified by zhengxuefeng, 2014-12 不然会报错
...
#else
#define ALWAYS_INLINE //inline  //removed by zhengxuefeng, 2014-12
#define NOINLINE
#endif
#define UNUSED
#define MAY_ALIAS
...
//modified by zhengxuefeng, 2014-12-5

//static inline int x264_is_regular_file( FILE *filehandle )
static ALWAYS_INLINE int x264_is_regular_file( FILE *filehandle )
{
...
static ALWAYS_INLINE int x264_is_regular_file_path( const char *filename )
{
#if 0
    x264_struct_stat file_stat;
