...
//added by zhengxuefeng,2014-12
/*char * strdup(char *str)
{
   char * strNew;
   assert(str != NULL);
   strNew = (char *)x264_malloc(strlen(str)+1);
   strcpy(strNew,str);
   return strNew;
}*/
...
#define OPT2(STR0, STR1) else if( !strcmp( name, STR0 ) || !strcmp( name, STR1 ) )
    ...
    OPT("cqm")
    {
        if( strstr( value, "flat" ) )
            ...
            p->psz_cqm_file = strdup((char*)value);
    }
    OPT("cqmfile")
        p->psz_cqm_file = strdup((char*)value);
    OPT("cqm4")
    ...
    OPT("dump-yuv")
        p->psz_dump_yuv = strdup((char*)value);
    ...
    OPT("stats")
    {
        p->rc.psz_stat_in = strdup((char*)value);
        p->rc.psz_stat_out = strdup((char*)value);
    }
    OPT("qcomp")
    ...
    OPT("zones")
        p->rc.psz_zones = strdup((char*)value);
    OPT("crop-rect")
    ...
    OPT("opencl-clbin")
        p->psz_clbin_file = strdup( (char*)value );
    OPT("opencl-device")
...
//modified by zhengxuefeng, 2014-12
    ...
    {
    	 {0, {0, 0, 0}, {0, 0, 0}},
        { 3, { 256*1, 256/2, 256/2 }, { 256*1, 256/2, 256/2 } },  //[X264_CSP_I420] 
        { 3, { 256*1, 256/2, 256/2 }, { 256*1, 256/2, 256/2 } },  //[X264_CSP_YV12]
        { 2, { 256*1, 256*1 },        { 256*1, 256/2 },       },         //[X264_CSP_NV12]
        { 3, { 256*1, 256/2, 256/2 }, { 256*1, 256*1, 256*1 } },  //[X264_CSP_I422]
        { 3, { 256*1, 256/2, 256/2 }, { 256*1, 256*1, 256*1 } },  //[X264_CSP_YV16]
        { 2, { 256*1, 256*1 },        { 256*1, 256*1 },       },         //[X264_CSP_NV16]
        {0, {0, 0, 0}, {0, 0, 0}},
        { 3, { 256*1, 256*1, 256*1 }, { 256*1, 256*1, 256*1 } },  //[X264_CSP_I444] 
        { 3, { 256*1, 256*1, 256*1 }, { 256*1, 256*1, 256*1 } },  //[X264_CSP_YV24]
        { 1, { 256*3 },               { 256*1 },              },               //[X264_CSP_BGR]
        { 1, { 256*4 },               { 256*1 },              },               //[X264_CSP_BGRA]
        { 1, { 256*3 },               { 256*1 },              },               //[X264_CSP_RGB]
    };

    

    int i, csp, depth_factor, frame_size, stride, plane_size ;
    int plane_offset[3] = {0};

    csp = i_csp & X264_CSP_MASK;
    ...
    {
        stride = (((int64_t)i_width * x264_csp_tab[csp].width_fix8[i]) >> 8) * depth_factor;
        plane_size = (((int64_t)i_height * x264_csp_tab[csp].height_fix8[i]) >> 8) * stride;
...
/*extern void *my_malloc(unsigned long  t_len);
extern void *my_free(void * pblk);

//by zhengxuefeng 2014-12
void *x264_malloc( int i_size )
{
