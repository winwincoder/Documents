...
extern "C"
JNIEXPORT void JNICALL Java_com_audio_Speex_doDenoise
    (JNIEnv *env, jobject obj, jbyteArray buf, jint size) {

	short *far_Mic = NULL;
	far_Mic = (short *)env->GetByteArrayElements(buf,0);
	doDenoise(far_Mic,size/2);
	env->ReleaseByteArrayElements(buf, (jbyte *)far_Mic, 0);
